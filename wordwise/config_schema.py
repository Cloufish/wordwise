...
class Profile(TypedDict):
    ...
    # Optional: field to search Pexels with instead of word_field (e.g. an
    # English translation, since Pexels tends to return better results for
    # English queries than for other languages). Empty string means "use
    # word_field". Missing on profiles saved before this option existed.
    ...
    gender_field: str
    # Which gender.SUPPORTED_LANGUAGES key to use for the lookup. Only meaningful
    # when gender_field is set.
    gender_language: str
